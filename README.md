...
1.0.7 - Added normal maps for OpenMW (thanks, Vegetto!), Added MWSE interop for Character Sound Overhaul, Added MWSE interop for Ashfall, Added mod metadata, Improved crystal golem visuals